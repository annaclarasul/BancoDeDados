...
CREATE TABLE `rotina` (
  ...
  CONSTRAINT `rotina_ibfk_1` FOREIGN KEY (`Cronograma_id`) REFERENCES `cronograma` (`id`),
  CONSTRAINT `rotina_ibfk_2` FOREIGN KEY (`aluno_id`) REFERENCES `aluno` (`id`)
...
INSERT INTO `rotina` VALUES (1,'Escola de manhã e cursinho de noite',1,1),(2,'cursinho de manhã e trabalho de noite',2,2),(3,'trabalho de manha e cursinho de noite',3,3);
